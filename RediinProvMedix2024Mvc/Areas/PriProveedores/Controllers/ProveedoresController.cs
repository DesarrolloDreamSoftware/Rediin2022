...
public class ProveedoresController : Controller
{
    ...
    public async Task<IActionResult> SubeArchivoIni(EProveedorMedix proveedor, Int32 indice)
    {
        //Guardar datos capturados antes de iniciar subir archivo
        if (proveedor != null)
            await ProveedorActualiza(proveedor, 4); //4 es la pagina de documentos
    ...
    public async Task<IActionResult> SubeArchivo(IFormFile archivo)
    {
        ...
        if (archivo == null || archivo.Length == 0)
        {
            ...
            return await SubeArchivoIni(null, indice);
