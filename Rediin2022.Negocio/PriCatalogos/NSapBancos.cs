...
namespace Rediin2022.Negocio.PriCatalogos
{
    ...
    public class NSapBancos : RSapBancos, INSapBancos
    {
        ...
        /// </summary>
        public new async Task<Boolean> SapBancoInserta(ESapBanco sapBanco)
        {
            //Validacion
            ...
            //Persistencia
            return await base.SapBancoInserta(sapBanco);
        }
        /// <summary>
        /// Valida y actualiza un registro en la base de datos.
        /// </summary>
        public new async Task<Boolean> SapBancoActualiza(ESapBanco sapBanco)
        {
            //Validacion
            if (!SapBancoValida(sapBanco))
                return false;
            ...
            //Persistencia
            return await base.SapBancoActualiza(sapBanco);
        }
        /// <summary>
        /// Elimina un registro de la base de datos.
        /// </summary>
        /// <returns></returns>
        public new async Task<Boolean> SapBancoElimina(ESapBanco sapBanco)
        {
            //Validacion
            ...
            //Persistencia
            return await base.SapBancoElimina(sapBanco);
        }
        /// <summary>
        ...
        {
            return await base.SapBancoExporta(sapBancoFiltro,
                                              _archivoExcel);
        }
        /// <summary>
        /// Reglas de negocio.
        ...
        {
            return await Task.Run(() => SapBancoReglasNeg().Rules);
        }
        /// <summary>
        ...
        private IMReglasNeg<ESapBanco> SapBancoReglasNeg()
        {
            ...
            _sapBancoReglas = Validaciones.CreaReglasNeg<ESapBanco>(Mensajes);
