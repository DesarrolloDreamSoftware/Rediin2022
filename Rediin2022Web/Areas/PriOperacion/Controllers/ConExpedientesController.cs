    ...
    public class ConExpedientesController : MControllerMvcPri
    {
        ...
        public IActionResult ConExpedienteInserta(IFormCollection conExp)
        {
            ...
            if (EVConExpedientes.ConExpProcOperativoSel.ProcesoOperativoId == EVConExpedientes.ParamProveedorProcesoOperativoId)
            {
                ...
                if (NExpedientes.Mensajes.Ok)
                    EnviaCorreo(conExpediente, vCve, vUsuario);
        ...
        private EClave CreaUsuario(EConExpediente conExpediente, out EUsuario usuario)
        {
            ...
            usuario.Usuario = usuario.Nombre.Trim().Replace(" ", "").Replace(".", "").Replace(",", "");
            ...
            {
                usuario.ApellidoPaterno = "Emp.";
                usuario.ApellidoMaterno = "Emp.";
            }
        ...
        private void EnviaCorreo(EConExpediente conExpediente, EClave clave, EUsuario usuario)
        {
            ...
            SmtpClient vServidor = base.ServidorCorreo("UmsoftRegistroClientes", out vCorreoOrig);
            ...
            vMensaje.To.Add(usuario.CorreoElectronico);
            vMensaje.Subject = "Su usuario de Proveedores ha sido creado.";
            vMensaje.Body =
                String.Format("Bienvenido a Proveedores.<br/><br/>Su usuario es {0}<br/>Su contraseña es {1}<br/>La URL donde puede acceder a sus sistema es:<br/>{2}",
                    usuario.Usuario, clave.ClaveVerif, "PENDIENTE LA URL");
