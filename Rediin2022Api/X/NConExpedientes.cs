...
namespace Rediin2022.Negocio.PriOperacion
{
    public class NConExpedientes : RConExpedientes, INConExpedientes
    {
        ...
        {
            //Validacion
            if (!ConExpedientePermiteActualiza(conExpediente))
            {
                _mensajes.AddError(MMensajesXId.PermiteActualizaErr);
                return false;
            }
            if (!ConExpedienteValida(conExpediente))
                return false;
        ...
        /// </summary>
        public new Boolean ConExpedienteCambioEstatusUno(EConExpedienteCambioEstatusUno conExpedienteCambioEstatusUno)
        {
            return base.ConExpedienteCambioEstatusUno(conExpedienteCambioEstatusUno);
        }
        /// <summary>
        /// Acción personalizada CambioEstatusDos.
        /// </summary>
        public new Boolean ConExpedienteCambioEstatusDos(EConExpedienteCambioEstatusDos conExpedienteCambioEstatusDos)
        {
            return base.ConExpedienteCambioEstatusDos(conExpedienteCambioEstatusDos);
        }
        ...
        /// </summary>
        public new Boolean ConExpedienteObjetoAgregarArchivo()
        {
        ...
        private IMReglasNeg<EConExpedienteObjeto> ConExpedienteObjetoReglasNeg()
        {
            ...
            _conExpedienteObjetoReglas.AddSL(e => e.ArchivoNombre, 0, 200, false);
